  ...
  return (
    <>
      ...
      <Swiper
       ...
       className="mySwiper flex flex-wrap justify-center mt-9 gap-2"
       >
                <SwiperSlide>
                ...
                <SwiperSlide>
                <img className='md:w-[500px] h-[270px]' src="https://www.bod.es/wp-content/gallery/monteburgos-m4-1b/2230_02_MVC_ImagenNocturna_01_v3_sin-logo.jpg" alt="" />
                </SwiperSlide>
