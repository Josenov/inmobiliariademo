...
const SobreNosotros = () => {
  return (
    <>
      <div id='#sobrenosotros' className='h-screen flex flex-col items-center'>
        <h2 className='text-2xl font-semibold mb-6'>Sobre Nosotros</h2>
        <p className='w-[800px]'>¡Bienvenido! Estamos ubicados en Cordoba Capital, especializados en ofrecerte los mejores alquileres temporarios para tus vacaciones. Entendemos la importancia de encontrar el lugar perfecto para disfrutar de tu tiempo en la costa y te lo damos.
